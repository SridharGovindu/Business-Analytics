...
news <- read_excel("Dataset_Union_budget_2024.xlsx")
...
set.seed(830)
news_sample <- news[sample(nrow(news), 1250),]
...
library(writexl)
write_xlsx(news, "2024cleaned.xlsx")
...
# Save to Excel
library(writexl)
write_xlsx(news_cleaned, "news_2024cleaned.xlsx")
